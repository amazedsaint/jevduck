...
export function createCeremony({
  ...
  // Embedded hosts have their own loading screen. Reveal the same rig
  // and world immediately, without changing any simulated robot state.
  function finishEntrance() {
    entranceT0 = null;
    entranceDone = true;
    respawn = null;
    lineCueIdx = lineCues.length;
    grid.material.uniforms.uReveal.value = 1;
    for (const m of wallMats) m.uniforms.uReveal.value = 1;
    bind();
    fx.start();
